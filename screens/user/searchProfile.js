...
export default function SearchProfile({navigation, route}) {
  // console.log(route);
  ...
  const requestConnection = async () => {
    ...
    .then(() => {
      navigation.navigate('Requested', {
        ...
        pic: thisProfile.pic,
        myMaritalStatus: thisProfile.myMaritalStatus,
        myQualification: thisProfile.myQualification,
        myEmploymentStatus: thisProfile.myEmploymentStatus,
        myLocation: thisProfile.myLocation,
        myAge: thisProfile.myAge,
        mateAge: thisProfile.mateAge,
        mateLocation: thisProfile.mateLocation,
        mateStateOfOrigin: thisProfile.mateStateOfOrigin,
        mateQualification: thisProfile.mateQualification,
      });
      ...
      <View style={styles.container}>
        <View style={styles.ImageContainer}>
          ...
          <View style={{flexDirection: 'row',  marginTop: 25, marginLeft: 15,  justifyContent: 'space-between'}}>
              <AntDesign name="arrowleft" onPress={()=> navigation.goBack()} size={32} color="black"  style={{backgroundColor: 'white', paddingHorizontal: 10, alignSelf: 'center',}}/>
              <TouchableOpacity>
